---
title: "Pythagorean Fifths on the Unit Circle"
format: html
---
...
Let $\theta_i, i = 1, 2, 3, ..., n$ be the angles of the points on the circle resulting from stacking pythagorean fifths.  For any continuous function $f$, we have $$
